...
struct MeshTraits : public OpenMesh::DefaultTraits
{
	...
	VertexAttributes(OpenMesh::Attributes::Status | OpenMesh::Attributes::Normal | OpenMesh::Attributes::TexCoord2D | OpenMesh::Attributes::TexCoord3D);
...
public:
	...
	static double Area(const Mesh& mesh, const OpenMesh::FaceHandle& fh);
	...
	static double CotanWeight(const Mesh& mesh, const OpenMesh::HalfedgeHandle& heh);
};
