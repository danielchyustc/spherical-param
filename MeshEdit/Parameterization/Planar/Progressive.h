...
#include "MeshEdit/Parameterization/PardisoSolver.h"
#include "MeshEdit/Parameterization/Planar/PlanarParam.h"

using namespace Eigen;
using namespace std;
double get_smallest_pos_quad_zero(double a, double b, double c);
class Progressive : public PlanarParam
{
public:
	Progressive(shared_ptr<Mesh> mesh_ptr);
	Progressive(Parameterization* param);

	bool Run() override;
	bool Iterate() override;
	bool IterateTillDone() override;
