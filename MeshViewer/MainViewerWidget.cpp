...
void MainViewerWidget::CreateParamWidget(void)
{
	...
	connect(meshparamwidget, SIGNAL(RunSignal()), meshviewerwidget, SLOT(EditorRun()));
	connect(meshparamwidget, SIGNAL(ResetSignal()), meshviewerwidget, SLOT(EditorReset()));
	connect(meshparamwidget, SIGNAL(ParamInitSignal()), meshviewerwidget, SLOT(ParamInit()));
	connect(meshparamwidget, SIGNAL(ParamIterSignal()), meshviewerwidget, SLOT(ParamIter()));
	connect(meshparamwidget, SIGNAL(ParamITDSignal()), meshviewerwidget, SLOT(ParamITD()));
	connect(meshparamwidget, SIGNAL(ParamResetSignal()), meshviewerwidget, SLOT(ParamReset()));
	connect(meshparamwidget, SIGNAL(ParamViewModeChangedSignal(QString)),
		meshviewerwidget, SLOT(ChangeParamViewMode(QString)));
	connect(meshparamwidget, SIGNAL(ParamInitMethodChangedSignal(QString)),
		meshviewerwidget, SLOT(ChangeParamInitMethod(QString)));
	connect(meshparamwidget, SIGNAL(ParamPlanarMethodChangedSignal(QString)),
		meshviewerwidget, SLOT(ChangeParamPlanarMethod(QString)));
	connect(meshparamwidget, SIGNAL(ParamSphericalMethodChangedSignal(QString)),
		meshviewerwidget, SLOT(ChangeParamSphericalMethod(QString)));
	connect(meshparamwidget, SIGNAL(ParamWeightChangedSignal(QString)),
		meshviewerwidget, SLOT(ChangeParamWeight(QString)));
}
...
void MainViewerWidget::SwitchDefaultMaterial(void)
{
	meshviewerwidget->SetMaterial(InteractiveViewerWidget::MaterialDefault);
}

void MainViewerWidget::SwitchGold(void)
{
	meshviewerwidget->SetMaterial(InteractiveViewerWidget::MaterialGold);
}

void MainViewerWidget::SwitchSilver(void)
{
	meshviewerwidget->SetMaterial(InteractiveViewerWidget::MaterialSilver);
}

void MainViewerWidget::SwitchEmerald(void)
{
	meshviewerwidget->SetMaterial(InteractiveViewerWidget::MaterialEmerald);
}

void MainViewerWidget::SwitchTin(void)
{
	meshviewerwidget->SetMaterial(InteractiveViewerWidget::MaterialTin);
}
...
void MainViewerWidget::LoadEditorTab(void)
{
	if (loadmeshsuccess)
	{
		meshparamwidget->AddEditorTab("editor");
		meshviewerwidget->InitEditor();
	}
	else
		cout << "Haven't loaded a mesh!" << endl;
}


void MainViewerWidget::LoadMinSurfTab(void)
{
	if (loadmeshsuccess)
	{
		meshparamwidget->AddEditorTab("minimal surface");
		meshviewerwidget->InitMinSurf();
	}
	else
		cout << "Haven't loaded a mesh!" << endl;
}
...
void MainViewerWidget::LoadParamTab(void)
{
	if (loadmeshsuccess)
	{
		meshparamwidget->AddParamTab(meshviewerwidget->InitParam());
	}
	else
		cout << "Haven't loaded a mesh!" << endl;
}
