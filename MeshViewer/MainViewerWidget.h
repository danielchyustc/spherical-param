...
public slots:
	...
	void SwitchDefaultMaterial(void);
	void SwitchGold(void);
	void SwitchSilver(void);
	void SwitchEmerald(void);
	void SwitchTin(void);
	...
	void LoadEditorTab(void);
	void LoadMinSurfTab(void);
	void LoadParamTab(void);
